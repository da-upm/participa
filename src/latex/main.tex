...
\cuerpo{
    Tras dicha recogida de propuestas, se sometieron a una votación abierta a todos los miembros de nuestra comunidad universitaria. 
    Posteriormente, tras el análisis de los datos recibidos, presentamos el siguiente documento que pretende sintetizar toda esa información, 
    trasladando de esta manera el sentir de nuestros compañeros y compañeras en una lista de objetivos. Esta se presentará a ambos candidatos, 
    los cuales, tras un proceso de negociación, se deberán comprometer a cumplir estas demandas a lo largo de los próximos 6 años de legislatura 
    en caso de salir elegidos. Posteriormente, se procederá a la publicación de este documento y la respuesta recibida en las redes sociales, 
    página web y en la plataforma destinada a las elecciones a rector de la UPM del 2024, para uso y conocimiento de todos.
}
